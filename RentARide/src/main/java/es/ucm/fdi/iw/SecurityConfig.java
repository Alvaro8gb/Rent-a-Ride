...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.antMatchers("/vehicle/{\\d+}/modify", "/vehicle/createVehicle", "/vehicle/carsManagement")
				...
				// Booking Controller
				.antMatchers("/booking/all", "/booking/list", "/booking/details", "/booking/confirmDelete/**")
				.hasAnyRole("ADMIN", "GESTOR")

				// Message Controller
				.antMatchers("/messages/in", "/messages/unread", "/messages/history/{\\d+}")
				.hasAnyRole("ADMIN", "GESTOR")

				// User Controller
				.antMatchers("/user/signup").permitAll()
				.antMatchers("/user/userList", "/user/{\\d+}/delete").hasAnyRole("ADMIN", "GESTOR")
